...
<COWORK>/civel/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "civel" / "cowork-state.json"
    ...
    pending_path = cowork / "civel" / ".memory-evolver-pending.json"
