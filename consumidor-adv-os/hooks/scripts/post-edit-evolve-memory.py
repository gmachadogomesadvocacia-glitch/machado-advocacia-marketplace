...
<COWORK>/consumidor/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "consumidor" / "cowork-state.json"
    ...
    pending_path = cowork / "consumidor" / ".memory-evolver-pending.json"
