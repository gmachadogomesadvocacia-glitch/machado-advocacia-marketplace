---
description: Aciona a governanca central (Tier 0) do plugin criminal-adv-os — 4 Camadas, roteamento de skills e leitura da config ativa (persona, fase, polo, situacao prisional).
