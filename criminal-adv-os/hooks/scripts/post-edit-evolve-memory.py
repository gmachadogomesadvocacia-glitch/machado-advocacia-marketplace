...
<COWORK>/criminal/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "criminal" / "cowork-state.json"
    ...
    pending_path = cowork / "criminal" / ".memory-evolver-pending.json"
