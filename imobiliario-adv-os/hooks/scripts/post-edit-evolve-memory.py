...
<COWORK>/imobiliario/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "imobiliario" / "cowork-state.json"
    ...
    pending_path = cowork / "imobiliario" / ".memory-evolver-pending.json"
