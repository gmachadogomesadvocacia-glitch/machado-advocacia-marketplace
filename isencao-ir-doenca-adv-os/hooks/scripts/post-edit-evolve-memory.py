...
<COWORK>/isencao-ir/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "isencao-ir" / "cowork-state.json"
    ...
    pending_path = cowork / "isencao-ir" / ".memory-evolver-pending.json"
