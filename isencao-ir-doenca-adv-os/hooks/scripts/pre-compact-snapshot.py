...
<COWORK>/isencao-ir/.snapshots/pre-compact-<timestamp>.md.
...
def _collect_memories(cowork: Path) -> list[tuple[str, Path]]:
    ...
    # Areas: primeiro nivel de subpastas (exclui isencao-ir e dot-dirs)
...
def main() -> int:
    ...
    snapshots_dir = cowork / "isencao-ir" / ".snapshots"
