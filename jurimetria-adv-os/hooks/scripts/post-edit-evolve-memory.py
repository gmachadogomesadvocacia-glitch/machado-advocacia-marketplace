...
<COWORK>/jurimetria/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "jurimetria" / "cowork-state.json"
    ...
    pending_path = cowork / "jurimetria" / ".memory-evolver-pending.json"
