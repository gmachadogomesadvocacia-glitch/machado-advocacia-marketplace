...
<COWORK>/jurimetria/.snapshots/pre-compact-<timestamp>.md.
...
def _collect_memories(cowork: Path) -> list[tuple[str, Path]]:
    ...
    # Areas: primeiro nivel de subpastas (exclui jurimetria e dot-dirs)
...
def main() -> int:
    ...
    snapshots_dir = cowork / "jurimetria" / ".snapshots"
