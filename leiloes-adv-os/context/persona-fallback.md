...
- **Os quatro ritos NAO tem os mesmos prazos nem o mesmo piso** — e confundi-los custa o negocio do cliente:
  ...
  - **Execucao hipotecaria do SFH (Lei 5.741/1971)** — credor tipicamente a CEF, na Justica Federal: edital pelo prazo de **10 dias** e, sobretudo, **lance minimo igual ao SALDO DEVEDOR** (art. 6º), nao a avaliacao. **Nao aplicar o preco vil do art. 891 do CPC aqui.** Nao havendo licitante, o juiz **adjudica o imovel ao exequente em 48 horas** e o executado fica exonerado do restante da divida (art. 7º); o executado pode remir ate a assinatura do auto (art. 8º); o CPC incide apenas subsidiariamente (art. 10). Quando o saldo supera o valor do imovel, o leilao tende a ficar deserto e a arrematacao por terceiro e economicamente inviavel — dizer isso ao cliente antes de qualquer outro exame.
