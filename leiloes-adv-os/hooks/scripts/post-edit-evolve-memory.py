...
<COWORK>/leiloes/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "leiloes" / "cowork-state.json"
    ...
    pending_path = cowork / "leiloes" / ".memory-evolver-pending.json"
