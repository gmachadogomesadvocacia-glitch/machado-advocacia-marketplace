...
<COWORK>/recuperacao-judicial/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "recuperacao-judicial" / "cowork-state.json"
    ...
    pending_path = cowork / "recuperacao-judicial" / ".memory-evolver-pending.json"
