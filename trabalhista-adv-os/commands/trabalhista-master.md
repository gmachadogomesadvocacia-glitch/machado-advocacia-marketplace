...
4. **Conduzir** toda demanda subsequente pelo pipeline: triagem (e Checkpoint 1) -> auditoria documental + CCT (Checkpoint 2) -> trilateral + jurisprudencia (Checkpoint 3) -> linha estrategica (Checkpoint 4) -> Tenente Tier 2 -> Suprema Corte R1-R5 -> entrega.
