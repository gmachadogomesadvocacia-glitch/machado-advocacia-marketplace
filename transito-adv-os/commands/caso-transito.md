---
description: Abre ou atualiza o CASO.md do caso ativo (Protocolo P3) em transito/casos/<slug>/ — memoria de caso compartimentada (sigilo OAB + LGPD, dados do condutor).
