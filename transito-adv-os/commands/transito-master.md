---
description: Aciona a governanca central (Tier 0) do plugin transito-adv-os — 4 Camadas, roteamento de skills e leitura da config ativa (persona, eixo, fase, pontuacao/CNH).
