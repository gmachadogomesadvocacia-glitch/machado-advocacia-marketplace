...
<COWORK>/transito/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "transito" / "cowork-state.json"
    ...
    pending_path = cowork / "transito" / ".memory-evolver-pending.json"
