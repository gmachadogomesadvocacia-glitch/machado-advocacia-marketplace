...
<COWORK>/tributario/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "tributario" / "cowork-state.json"
    ...
    pending_path = cowork / "tributario" / ".memory-evolver-pending.json"
