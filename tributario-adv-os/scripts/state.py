...
def create_empty(cowork_path: Path, *, firm_name: str, firm_slug: str,
    ...
    return {
        ...
        "revisao_tecnica": {
            ...
            "auto_apply_to": ["peticoes", "contestacoes", "pareceres", "calculos"],
        },
        "tools": {
