...
<COWORK>/usucapiao/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "usucapiao" / "cowork-state.json"
    ...
    pending_path = cowork / "usucapiao" / ".memory-evolver-pending.json"
